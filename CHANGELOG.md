...
- `--headless` option for `mcpc login` to support OAuth on headless environments without a browser; prints the authorization URL and accepts a pasted callback URL
