...
### Fixed
- Session restart now auto-detects OAuth profiles created after the session was established, fixing the `login` then `restart` flow for unauthorized sessions
